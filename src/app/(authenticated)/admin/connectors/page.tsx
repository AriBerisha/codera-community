...
function AtlassianIcon() {
  return (
    <svg className="h-5 w-5 text-[#2684FF]" viewBox="0 0 24 24" fill="currentColor">
      <path d="M7.127 11.167c-.204-.338-.547-.345-.764-.014L.357 21.357c-.217.331-.054.643.35.643h7.48c.2 0 .455-.162.555-.348.744-1.385 1.07-3.926-.615-10.485zM12.039.655c-3.065 5.261-2.645 9.496-.475 13.834l3.14 6.264c.138.278.39.447.652.447h7.48c.404 0 .568-.312.35-.643L12.801.641c-.22-.337-.542-.337-.762.014z" />
    </svg>
  );
}
